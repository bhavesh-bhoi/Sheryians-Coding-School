      ...
      <div className="grid grid-cols-2 gap-5 p-4">
        ...
        <div className="bg-white h-fit w-96 p-1.5 shadow-lg rounded-[40px]">
          <div className="h-48 w-full inline-block relative rounded-[35px] overflow-hidden">
            ...
            />
            <div className="bg-gray-200 px-3 py-3 rounded-full flex justify-center items-center absolute top-3 right-3 cursor-pointer hover:bg-gray-300 text-xl font-semibold">
          ...
          {/* Name and Description */}
            <p className="p-1 text-center ml-9">exp !!!!!!!!!!!!!!!</p>
          <div className="p-1.5 text-left w-70 mx-auto">
            <h2 className="text-3xl font-semibold mt-10">John Doe</h2>
        ...
        <div className="bg-white h-fit w-96 p-1.5 shadow-lg rounded-[40px]">
          <div className="h-48 w-full inline-block relative rounded-[35px] overflow-hidden">
            <img
              ...
              className="rounded-[35px] object-cover h-full w-full"
            />
            <div className="bg-gray-200 px-3 py-3 rounded-full flex justify-center items-center absolute top-3 right-3 cursor-pointer hover:bg-gray-300 text-4xl">
              <HugeiconsIcon strokeWidth={2} icon={Add01Icon} />
            </div>
          </div>
